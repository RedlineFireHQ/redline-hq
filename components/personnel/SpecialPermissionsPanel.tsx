...
const CATEGORIES: PermissionCategory[] = [
  ...
  { name: "Maintenance", description: "Manage maintenance records and service workflows.", accessNote: "Maintenance management allows this member to create, edit, and manage maintenance records.", icon: Wrench, primary: { key: "maintenance_management", label: "Manage Maintenance", description: "Allows this member to manage maintenance records and workflows." } },
