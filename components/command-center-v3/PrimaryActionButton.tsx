...
export default function PrimaryActionButton({
  ...
  const classes = `group flex h-[42px] w-full items-center justify-center gap-2 rounded-2xl border border-red-500/40 bg-gradient-to-b from-[#ff3b3b] to-[#b90d0d] px-4 text-white shadow-[0_0_18px_rgba(239,43,45,.28)] transition-all duration-300 hover:shadow-[0_0_26px_rgba(239,43,45,.40)] active:translate-y-[1px] active:shadow-[0_0_14px_rgba(239,43,45,.24)] ${className}`;
